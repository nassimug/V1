...
<div class="container">
    <div class="row">
        <div class="col-lg-12 mb-4">
            <!--------------------- FILTRE ------------------------>
            <div class="btn-group">
            <button type="button" class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: #3498db;">
        ...
        <div class="btn-group">
            <a href="{{ route('users.create') }}" class="btn" style="margin: 20px 0px 20px 0px; background-color: #3498db;" >
                        ...
                        <div class="table-responsive">
                            <table class="table user-list">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        <td>
                                            <img src="{{ $user->role == 'admin' ? 'https://bootdey.com/img/Content/avatar/avatar1.png' :
                                                ($user->role == 'enseignant' ? 'https://bootdey.com/img/Content/avatar/avatar3.png' :
                                                ($user->role == 'etudiant' ? 'https://bootdey.com/img/Content/avatar/avatar2.png' :
                                                ($user->role == 'chercheur' ? 'https://bootdey.com/img/Content/avatar/avatar4.png' :
                                                'https://bootdey.com/img/Content/avatar/avatar5.png'))) }}" alt="">
